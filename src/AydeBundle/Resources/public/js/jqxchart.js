...
;(function($, undefined) {
  $.fn.drawPieChart = function(data, options) {
    ...
    //Set up tooltip
    var $tip = $('<div id="divMortal" class="' + settings.tipClass + '" />').appendTo('body').hide(),
      tipW = $tip.width(),
      tipH = $tip.height();
    ...
    for (var i = 0, len = data.length; i < len; i++){
      ...
      p.setAttribute("opacity", data[i].opacity);
    ...
    function pathClick(e){
      ...
      if (targetGroup.getAttribute("data-active") === "active"){
        ...
        //clickBloquesPresentes(idBloque);
    ...
    function drawPieSegments (animationDecimal){
      ...
      //draw each path
      for (var i = 0, len = data.length; i < len; i++){
        var segmentAngle = rotateAnimation * ((data[i].value/segmentTotal) * (PI)),//start radian
